                    ...
                    <div class="carrito">
                        ...
                        <div id="carrito" class="bg-white p-3">
                            ...
                            <div v-else>
                                        ...
                                        <tr v-for="producto in carrito" key="producto.id">
                                            ...
                                            <td class="flex align-items-start gap-4">
                                                <button type="button" class="btn btn-dark"
                                                    @click="$emit('decrementarCantidad', producto.id)">
                                                    -
                                                </button>
                                                {{ producto.cantidad }}
                                                <button type="button" class="btn btn-dark"
                                                    @click="$emit('incrementarCantidad', producto.id)">
                                                    +
                                                </button>
                                            </td>
                                            <td>
                                ...
                                <button class="btn btn-dark w-100 mt-3 p-2" @click="$emit('vaciarCarrito')">Vaciar
                                    Carrito</button>
                            </div>
                        </div>
                    </div>
